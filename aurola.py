...
try:
    ...
    firework_sound.set_volume(1.0)
except pygame.error as e:
    print(f"Error loding soound file {e}")
    firework_sound = None
...
def update_fireworks():
    ...
    for fw in state["fireworks"]:
        ...
        if age < fw["duration"]:
            ...
            for _ in range(size * 8):  # Increase number of particles
                ...
                color = fade_color(color, intensity)  # Apply fading
...
# Start displaying fireworks in a separate thread
